...
nfiles=13
files=( "dynamicWaterlevelCorrection.61.nc"  "dynamicWaterlevelCorrection.63.nc"  
        "fort.61.nc"  "fort.63.nc"  "fort.62.nc"  "fort.64.nc"  "fort.71.nc"  "fort.72.nc"  
        "fort.73.nc"  "fort.74.nc"  "maxele.63.nc"  "maxvel.63.nc"  "maxwvel.63.nc"  "minpr.63.nc" )
