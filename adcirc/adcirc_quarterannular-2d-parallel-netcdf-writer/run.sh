...
case_name="adcirc_quarterannular-2d-parallel-netcdf-writer"
...
nfiles=6
files=( "fort.61.nc" "fort.62.nc" "fort.63.nc" "fort.64.nc" "maxele.63.nc" "maxvel.63.nc" )
...
mpirun --allow-run-as-root -np $np $exepath/padcirc -W 1 > padcirc.log
exitstat=$?
echo "Finished"
